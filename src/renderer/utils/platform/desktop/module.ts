...
exports.resolveModule = function (request: string, context: string) {
...
exports.loadModule = function (request: string, context: string, force = false) {
  try {
...
exports.clearModule = function (request: any, context: any) {
  const resolvedPath = exports.resolveModule(request, context)
  if (resolvedPath) {
    clearRequireCache(resolvedPath)
  }
